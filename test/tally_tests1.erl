...
-import(test_ast, [norm_css_basic/1, norm_substs/1, norm/1, d/2, mu/2, n/1, b/0, b/1, f/2, t/2, i/2, i/1, u/2, u/1, r/1, r/0, none/0, any/0, v/1, subty/2, normalize/3, normalize/2, var_of/1, norm_css/1]).
%%
...
slow_tally_test_() ->
  {
    timeout, 30,
    fun() ->
      lists:foreach(fun(Var) -> test_ast:norm(Var), ok end,
        [ v(a00), v(a01), v(a02), v(a03), v(a04), v(a05), v(a06), v(a07), v(a08), v(a09), v(a10), v(a11), v(a12), v(a13), v(a14), v(a15), v(a16), v(a17), v(a18), v(a19), v(a20), v(a21), v(a22) ]),
...
%%    { i(v(a6), AnyTag), t(v(a10), b(tag))},
        { t(d(any(), v(a10)), b(tag)), n(v(a06))},
%%    { i(v(a6), AnyTag), t(v(a09), b(tag))},
        { t(d(any(), v(a09)), b(tag)), n(v(a06))},

        { i(v(a00), i(T0, T0)), T0}, % empty...
